...
MENU_TEMPLATE_ITEM MainMenuTemplate[] =
    {
        ...
        {MNTT_IT, IDS_MENU_LEFT_HSWAPPANELS, MNTS_I | MNTS_A, CM_HSWAP_LEFT, -1, 0, NULL},
        {MNTT_IT, IDS_MENU_LEFT_VSWAPPANELS, MNTS_I | MNTS_A, CM_VSWAP_LEFT, -1, 0, NULL},
        ...
        // Bottom Left
        {MNTT_PB, IDS_MENU_BOTTOMLEFT, MNTS_B | MNTS_I | MNTS_A, CML_BOTTOMLEFT, -1, 0, NULL},
        {MNTT_IT, IDS_MENU_BOTTOMLEFT_CHANGEDRIVE, MNTS_B | MNTS_I | MNTS_A, CM_BLCHANGEDRIVE, -1, 0, NULL},
        {MNTT_PB, IDS_MENU_LEFT_GO, MNTS_B | MNTS_I | MNTS_A, CML_BOTTOMLEFT_GO, -1, 0, NULL},
        {MNTT_IT, IDS_MENU_LEFT_GO_BACK, MNTS_B | MNTS_I | MNTS_A, CM_BLBACK, IDX_TB_BACK, 0, &EnablerBottomLeftBackward},
        {MNTT_IT, IDS_MENU_LEFT_GO_FORWARD, MNTS_B | MNTS_I | MNTS_A, CM_BLFORWARD, IDX_TB_FORWARD, 0, &EnablerBottomLeftForward},
        {MNTT_IT, IDS_MENU_LEFT_GO_UPDIR, MNTS_B | MNTS_I | MNTS_A, CM_BLPARENTDIR, IDX_TB_PARENTDIR, 0, &EnablerBottomLeftUpDir},
        {MNTT_IT, IDS_MENU_LEFT_GO_ROOT, MNTS_B | MNTS_I | MNTS_A, CM_BLROOTDIR, IDX_TB_ROOTDIR, 0, &EnablerBottomLeftRootDir},
        {MNTT_IT, IDS_MENU_LEFT_GO_OTHER, MNTS_B | MNTS_I | MNTS_A, CM_BOTTOMLEFT_AS_OTHER, IDX_TB_AS_OTHER_PANEL, 0, NULL},
        {MNTT_PE},
        // TRANSLATOR_INSERT: IDS_BRIEF_VIEW, IDS_DETAILED_VIEW, IDS_ICONS_VIEW, IDS_THUMBNAILS_VIEW, IDS_TILES_VIEW, IDS_TYPES_VIEW
        {MNTT_SP, -1, MNTS_B | MNTS_I | MNTS_A, CML_BOTTOMLEFT_VIEWS1, -1, 0, NULL},
        {MNTT_SP, -1, MNTS_B | MNTS_I | MNTS_A, CML_BOTTOMLEFT_VIEWS2, -1, 0, NULL},
        {MNTT_PB, IDS_MENU_LEFT_SORTBY, MNTS_B | MNTS_I | MNTS_A, CML_BOTTOMLEFT_SORTBY, -1, 0, NULL},
        {MNTT_PE},
        {MNTT_PB, IDS_MENU_LEFT_VSB, MNTS_A, CML_BOTTOMLEFT_VISIBLE, -1, 0, NULL},
        {MNTT_IT, IDS_MENU_LEFT_VSB_DIRLINE, MNTS_A, CM_BOTTOMLEFTDIRLINE, -1, 0, NULL},
        {MNTT_IT, IDS_MENU_LEFT_VSB_HDRLINE, MNTS_A, CM_BOTTOMLEFTHEADER, -1, 0, NULL},
        {MNTT_IT, IDS_MENU_LEFT_VSB_INFOLINE, MNTS_A, CM_BOTTOMLEFTSTATUS, -1, 0, NULL},
        {MNTT_PE},
        {MNTT_IT, IDS_MENU_LEFT_VIEW, MNTS_A, CM_BOTTOMLCUSTOMIZEVIEW, -1, 0, &EnablerCustomizeBottomLeftView},
        {MNTT_SP, -1, MNTS_B | MNTS_I | MNTS_A, 0, -1, 0, NULL},
        {MNTT_IT, IDS_MENU_LEFT_ZOOM, MNTS_I | MNTS_A, CM_BOTTOMLEFTZOOMPANEL, -1, 0, NULL},
        {MNTT_IT, IDS_MENU_LEFT_HSWAPPANELS, MNTS_I | MNTS_A, CM_HSWAP_BOTTOMLEFT, -1, 0, NULL},
        {MNTT_IT, IDS_MENU_LEFT_VSWAPPANELS, MNTS_I | MNTS_A, CM_VSWAP_BOTTOMLEFT, -1, 0, NULL},
        {MNTT_SP, -1, MNTS_I | MNTS_A, 0, -1, 0, NULL},
        {MNTT_IT, IDS_MENU_LEFT_FILTER, MNTS_I | MNTS_A, CM_BLCHANGEFILTER, IDX_TB_FILTER, 0, NULL},
        {MNTT_IT, IDS_MENU_LEFT_REFRESH, MNTS_B | MNTS_I | MNTS_A, CM_BOTTOMLEFTREFRESH, IDX_TB_REFRESH, 0, NULL},
        {MNTT_PE},
        ...
        // : added for bottom customizers too
        {MNTT_IT, IDS_MENU_OPT_CST_BOTTOMLEFT, MNTS_I | MNTS_A, CM_CUSTOMIZEBOTTOMLEFT, -1, 0, NULL},
        {MNTT_IT, IDS_MENU_OPT_CST_BOTTOMRIGHT, MNTS_I | MNTS_A, CM_CUSTOMIZEBOTTOMRIGHT, -1, 0, NULL},
        ...
        // Bottom Right
        {MNTT_PB, IDS_MENU_BOTTOMRIGHT, MNTS_B | MNTS_I | MNTS_A, CML_BOTTOMRIGHT, -1, 0, NULL},
        {MNTT_IT, IDS_MENU_BOTTOMRIGHT_CHANGEDRIVE, MNTS_B | MNTS_I | MNTS_A, CM_BRCHANGEDRIVE, -1, 0, NULL},
        {MNTT_PB, IDS_MENU_LEFT_GO, MNTS_B | MNTS_I | MNTS_A, CML_BOTTOMRIGHT_GO, -1, 0, NULL},
        {MNTT_IT, IDS_MENU_LEFT_GO_BACK, MNTS_B | MNTS_I | MNTS_A, CM_BRBACK, IDX_TB_BACK, 0, &EnablerBottomRightBackward},
        {MNTT_IT, IDS_MENU_LEFT_GO_FORWARD, MNTS_B | MNTS_I | MNTS_A, CM_BRFORWARD, IDX_TB_FORWARD, 0, &EnablerBottomRightForward},
        {MNTT_IT, IDS_MENU_LEFT_GO_UPDIR, MNTS_B | MNTS_I | MNTS_A, CM_BRPARENTDIR, IDX_TB_PARENTDIR, 0, &EnablerBottomRightUpDir},
        {MNTT_IT, IDS_MENU_LEFT_GO_ROOT, MNTS_B | MNTS_I | MNTS_A, CM_BRROOTDIR, IDX_TB_ROOTDIR, 0, &EnablerBottomRightRootDir},
        {MNTT_IT, IDS_MENU_LEFT_GO_OTHER, MNTS_B | MNTS_I | MNTS_A, CM_BOTTOMRIGHT_AS_OTHER, IDX_TB_AS_OTHER_PANEL, 0, NULL},
        {MNTT_PE},
        // TRANSLATOR_INSERT: IDS_BRIEF_VIEW, IDS_DETAILED_VIEW, IDS_ICONS_VIEW, IDS_THUMBNAILS_VIEW, IDS_TILES_VIEW, IDS_TYPES_VIEW
        {MNTT_SP, -1, MNTS_B | MNTS_I | MNTS_A, CML_BOTTOMRIGHT_VIEWS1, -1, 0, NULL},
        {MNTT_SP, -1, MNTS_B | MNTS_I | MNTS_A, CML_BOTTOMRIGHT_VIEWS2, -1, 0, NULL},
        {MNTT_PB, IDS_MENU_LEFT_SORTBY, MNTS_B | MNTS_I | MNTS_A, CML_BOTTOMRIGHT_SORTBY, -1, 0, NULL},
        {MNTT_PE},
        {MNTT_PB, IDS_MENU_LEFT_VSB, MNTS_A, CML_BOTTOMRIGHT_VISIBLE, -1, 0, NULL},
        {MNTT_IT, IDS_MENU_LEFT_VSB_DIRLINE, MNTS_A, CM_BOTTOMRIGHTDIRLINE, -1, 0, NULL},
        {MNTT_IT, IDS_MENU_LEFT_VSB_HDRLINE, MNTS_A, CM_BOTTOMRIGHTHEADER, -1, 0, NULL},
        {MNTT_IT, IDS_MENU_LEFT_VSB_INFOLINE, MNTS_A, CM_BOTTOMRIGHTSTATUS, -1, 0, NULL},
        {MNTT_PE},
        {MNTT_IT, IDS_MENU_LEFT_VIEW, MNTS_A, CM_BOTTOMRCUSTOMIZEVIEW, -1, 0, &EnablerCustomizeBottomRightView},
        {MNTT_SP, -1, MNTS_B | MNTS_I | MNTS_A, 0, -1, 0, NULL},
        {MNTT_IT, IDS_MENU_LEFT_ZOOM, MNTS_I | MNTS_A, CM_BOTTOMRIGHTZOOMPANEL, -1, 0, NULL},
        {MNTT_IT, IDS_MENU_LEFT_HSWAPPANELS, MNTS_I | MNTS_A, CM_HSWAP_BOTTOMRIGHT, -1, 0, NULL},
        {MNTT_IT, IDS_MENU_LEFT_VSWAPPANELS, MNTS_I | MNTS_A, CM_VSWAP_BOTTOMRIGHT, -1, 0, NULL},
        {MNTT_SP, -1, MNTS_I | MNTS_A, 0, -1, 0, NULL},
        {MNTT_IT, IDS_MENU_LEFT_FILTER, MNTS_I | MNTS_A, CM_BRCHANGEFILTER, IDX_TB_FILTER, 0, NULL},
        {MNTT_IT, IDS_MENU_LEFT_REFRESH, MNTS_B | MNTS_I | MNTS_A, CM_BOTTOMRIGHTREFRESH, IDX_TB_REFRESH, 0, NULL},
        {MNTT_PE},
        ...
        {MNTT_IT, IDS_MENU_LEFT_HSWAPPANELS, MNTS_I | MNTS_A, CM_HSWAP_RIGHT, -1, 0, NULL},
        {MNTT_IT, IDS_MENU_LEFT_VSWAPPANELS, MNTS_I | MNTS_A, CM_VSWAP_RIGHT, -1, 0, NULL},
        {MNTT_SP, -1, MNTS_I | MNTS_A, 0, -1, 0, NULL},
